...
public class PhotoGalleyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            if (type == ITME_CAMERA) {
                convertView = mLayoutInflater.inflate(R.layout.piclib_grid_camera_item, parent, false);

            } else {
                convertView = mLayoutInflater.inflate(R.layout.piclib_grid_photo_item, parent, false);
                holder = new ViewHolder();
                holder.photo = convertView.findViewById(R.id.ic_image_pick);
                holder.selectFlag = convertView.findViewById(R.id.ic_check_box);
