...
public class ActivityUtils {
    ...
    public static void fStartActivtiy(Fragment activity, Intent intent) {
        ...
        activity.getActivity().overridePendingTransition(R.anim.piclib_push_in_right, R.anim.piclib_push_out_left);
    ...
    public static void startActivity(Activity activity, Intent intent) {
        activity.startActivity(intent);
        activity.overridePendingTransition(R.anim.piclib_push_in_right, R.anim.piclib_push_out_left);
        add(activity);
    }
    ...
    public static void startPicActivity(Activity activity, Intent intent) {
        activity.startActivity(intent);
        activity.overridePendingTransition(R.anim.piclib_push_in_center_tobig, R.anim.piclib_push_out_no);
        add(activity);
    }
    ...
    public static void finishPicActivity(Activity activity) {
        remove(activity);
        activity.finish();
        activity.overridePendingTransition(R.anim.piclib_push_out_no, R.anim.piclib_push_in_center_tolitter);
    }

    public static void finishActivity(Activity activity) {
        remove(activity);
        activity.finish();
        activity.overridePendingTransition(R.anim.piclib_push_in_left, R.anim.piclib_push_out_right);
    }
    ...
    public static void startActivityUpAnim(Activity activity, Intent intent) {
        activity.startActivity(intent);
        activity.overridePendingTransition(R.anim.piclib_push_in_down, R.anim.piclib_push_out_nochange);
        activitys.add(activity.getClass().getSimpleName());
    }
    ...
    public static void finishLoginActivity(Activity activity) {
        ...
        activity.finish();
        activity.overridePendingTransition(R.anim.piclib_push_out_nochange, R.anim.piclib_push_out_down);
    }
    ...
    public static void startMyApplicationDetailsForResult(Activity cxt, String packageName) {
        ...
        cxt.startActivityForResult(intent, REQUEST_SETTING_APP_DETAILS);
