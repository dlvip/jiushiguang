...
public abstract class BaseDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window;
        if (dialog_location == R.style.dialog_setting) {
            setContentView(view);
        ...
        } else if (dialog_location == R.style.transparentFrameWindowStyle) {
        ...
        } else if (dialog_location == R.style.dialog_setting_edt) {
            setCanceledOnTouchOutside(true);
            setContentView(view);
