package com.old.time.music.client;
...
import com.old.time.music.client.listener.OnSaveRecordListener;
import com.old.time.music.client.model.IMusicInfo;
import com.old.time.music.client.utils.MusicConvertUtil;
import com.old.time.music.client.utils.NetUtils;
import com.old.time.music.service.MusicPlaybackManager;
import com.old.time.music.service.MusicService;
import com.old.time.music.setting.SettingConfig;
...
public class MusicManager {
    ...
    public boolean isPlaying() {
        ...
        return state.getState() == PlaybackStateCompat.STATE_PLAYING || state.getState() == PlaybackStateCompat.STATE_BUFFERING;
    }
    ...
    public String getCurrentPlayMediaId() {
        if (mMediaController == null) return null;
    ...
    public <T extends IMusicInfo> void playMusicList(final List<T> list, final int playIndex) {
        ...
        // 当前没有播放数据
            ...
            // 播放队列数据
            mMediaController.getTransportControls().sendCustomAction(MusicPlaybackManager.CUSTOM_ACTION_MUSIC_PLAY_QUNEN, args);
        }
    }
    ...
    public <T extends IMusicInfo> void updatePlayList(final List<T> list, final int playIndex) {
        ...
        if (mPlayList != null && list.equals(mPlayList)) {
            ...
            args.putParcelableArrayList(MusicPlaybackManager.KEY_MUSIC_QUEUE, MusicConvertUtil.convertToMediaMetadataList(list));
            args.putInt(MusicPlaybackManager.KEY_MUSIC_QUEUE_PLAY_INDEX, playIndex);
            mMediaController.getTransportControls().sendCustomAction(MusicPlaybackManager.CUSTOM_ACTION_MUSIC_UPDATE_QUNEN, args);
        }
    }
     ...
     */
    public void play() {
        if (mTransportControls != null) mTransportControls.play();
    }
     ...
     */
    public void pause() {
        if (mTransportControls != null) mTransportControls.pause();
    }
     ...
     */
    public void stop() {
        if (mTransportControls != null) mTransportControls.stop();
    }
    ...
    private final MediaControllerCompat.Callback mMediaControllerCallback = new MediaControllerCompat.Callback() {
        ...
        public void onPlaybackStateChanged(@NonNull PlaybackStateCompat state) {
            Log.d(TAG, "mediaControllerCallback.onPlaybackStateChanged: " + "state is " + state.getState());
    ...
    public boolean isNetWorkAllow() {
        ...
        return NetUtils.isWIFI(mContext) || SettingConfig.isGPRSPlayAllowed(mContext);
    }
