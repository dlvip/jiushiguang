package com.old.time.puzzle;

import com.old.time.puzzle.template.slant.OneSlantLayout;
import com.old.time.puzzle.template.slant.SlantLayoutHelper;
import com.old.time.puzzle.template.slant.ThreeSlantLayout;
import com.old.time.puzzle.template.slant.TwoSlantLayout;
import com.old.time.puzzle.template.straight.EightStraightLayout;
import com.old.time.puzzle.template.straight.FiveStraightLayout;
import com.old.time.puzzle.template.straight.FourStraightLayout;
import com.old.time.puzzle.template.straight.NineStraightLayout;
import com.old.time.puzzle.template.straight.OneStraightLayout;
import com.old.time.puzzle.template.straight.SevenStraightLayout;
import com.old.time.puzzle.template.straight.SixStraightLayout;
import com.old.time.puzzle.template.straight.StraightLayoutHelper;
import com.old.time.puzzle.template.straight.ThreeStraightLayout;
import com.old.time.puzzle.template.straight.TwoStraightLayout;
