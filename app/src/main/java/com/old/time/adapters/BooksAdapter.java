...
public class BooksAdapter extends BaseQuickAdapter<BookEntity, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, final BookEntity item) {
        ...
        helper.setText(R.id.tv_book_name, item.getTitle())//
                .setText(R.id.tv_book_author, String.valueOf("作者：" + item.getAuthor() + " / " + item.getBinding()))//
                ...
                .addOnClickListener(R.id.img_book_cart)//
                .setGone(R.id.img_book_cart, !item.isSelect());
    }
}
