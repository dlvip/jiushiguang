...
public class PlayPauseDrawable extends Drawable {
    ...
    public PlayPauseDrawable(Context context) {
        ...
        mPauseBarWidth = res.getDimensionPixelSize(R.dimen.layout_45);
        mPauseBarHeight = res.getDimensionPixelSize(R.dimen.layout_140);
        mPauseBarDistance = res.getDimensionPixelSize(R.dimen.layout_40);
    }
