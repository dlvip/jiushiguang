...
public class Config {
    ...
    final static String FONTTYPE_DEFAULT = "";
    final static String FONTTYPE_QIHEI = "font/qihei.ttf";
    public final static String FONTTYPE_WAWA = "font/font1.ttf";

    final static String FONTTYPE_FZXINGHEI = "font/fzxinghei.ttf";
    final static String FONTTYPE_FZKATONG = "font/fzkatong.ttf";
    final static String FONTTYPE_BYSONG = "font/bysong.ttf";

    final static int BOOK_BG_DEFAULT = 0;
    final static int BOOK_BG_1 = 1;
    final static int BOOK_BG_2 = 2;
    final static int BOOK_BG_3 = 3;
    final static int BOOK_BG_4 = 4;

    final static int PAGE_MODE_SIMULATION = 0;
    final static int PAGE_MODE_COVER = 1;
    final static int PAGE_MODE_SLIDE = 2;
    final static int PAGE_MODE_NONE = 3;
    ...
    public static synchronized Config getInstance() {
        if (config == null) {
            config = createConfig(MyApplication.getInstance().mContext);

        }
        return config;
    }

    private static synchronized Config createConfig(Context context) {
        if (config == null) {
    ...
    public float getFontSize() {
        if (mFontSize == 0) {
            mFontSize = sp.getFloat(FONT_SIZE_KEY, mContext.getResources().getDimension(R.dimen.layout_20));
        }
        return mFontSize;
    }
