...
public class SearchEditText extends AppCompatEditText implements OnFocusChangeListener, TextWatcher {
    /**
     * 删除按钮的引用
     */
    ...
    protected void setClearIconVisible(boolean visible) {
        ...
        if (right == null && deleListener != null)
            deleListener.onDeleStr();
        setCompoundDrawables(getCompoundDrawables()[0],
    ...
    public void setDeleListener(OnDeleListener listener){
        this.deleListener = listener;
    }
