...
public class CompletedView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray typeArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CompletedView, 0, 0);
        mRadius = typeArray.getDimension(R.styleable.CompletedView_radius, UIHelper.dip2px(20));
        mStrokeWidth = typeArray.getDimension(R.styleable.CompletedView_strokeWidth, UIHelper.dip2px(2));
