...
public class NiceVideoPlayer extends FrameLayout implements INiceVideoPlayer, TextureView.SurfaceTextureListener {
    ...
    private static String TAG = "NiceVideoPlayer";
    ...
    public void setSpeed(float speed) {
        if (mMediaPlayer instanceof IjkMediaPlayer) {
            ...
            DebugLog.d(TAG, "只有IjkPlayer才能设置播放速度");
    ...
    public void start() {
        if (mCurrentState == STATE_IDLE) {
            ...
            DebugLog.d(TAG, "NiceVideoPlayer只有在mCurrentState == STATE_IDLE时才能调用start方法.");
    ...
    public void restart() {
        if (mCurrentState == STATE_PAUSED) {
            ...
            DebugLog.d(TAG, "NiceVideoPlayer在mCurrentState == " + mCurrentState + "时不能调用restart()方法.");
    ...
    private void openMediaPlayer() {
        ...
        try {
            ...
            e.printStackTrace();
            DebugLog.e("打开播放器发生错误", e.getMessage());
        }
    }
    ...
    public void enterTinyWindow() {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams((int) (NiceUtil.getScreenWidth(mContext) * 0.6f), (int) (NiceUtil.getScreenWidth(mContext) * 0.6f * 9f / 16f));
