...
import com.old.time.manager.BroadcastManager;
...
public class PlayService extends RootService {
    ...
    public void onCreate() {
        ...
        new ServiceInit(this, iBinder, mediaManager, playPreference,
                dbController,
    ...
    public IBinder onBind(Intent intent) {
        ...
        int check = checkCallingOrSelfPermission("com.old.time.permission.ACCESS_PLAY_SERVICE");
