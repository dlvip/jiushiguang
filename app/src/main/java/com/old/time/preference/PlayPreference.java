package com.old.time.preference;

import android.content.Context;
import android.support.annotation.Nullable;

import com.old.time.db.MainSheetHelper;
...
public class PlayPreference extends BasePreference {
    ...
    /**
     * 0 为全部，其它的歌单 信息 可从 {@link com.old.time.db.DBMusicocoController#getSheet(String)}等方法获得
     */
