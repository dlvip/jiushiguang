...
public class ScrollManager {
    ...
    public void updateComsume() {
        mConsumeX += UIHelper.dip2px(GalleryItemDecoration.mLeftPageVisibleWidth + GalleryItemDecoration.mPageMargin * 2);
        mConsumeY += UIHelper.dip2px(GalleryItemDecoration.mLeftPageVisibleWidth + GalleryItemDecoration.mPageMargin * 2);
        DebugLog.d(TAG, "updateComsume mConsumeX=" + mConsumeX);
    }
    ...
    private void onVerticalScroll(final RecyclerView recyclerView, int dy) {
        ...
        recyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                DebugLog.d(TAG, "offset=" + offset + "; mConsumeY=" + mConsumeY + "; shouldConsumeY=" + shouldConsumeY);
    ...
    private void onHoritiontalScroll(final RecyclerView recyclerView, final int dx) {
        DebugLog.d(TAG, "mConsumeX=" + mConsumeX + "; dx=" + dx);
        mConsumeX += dx;
        ...
        recyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                DebugLog.d(TAG, "offset=" + offset + "; percent=" + percent + "; mConsumeX=" + mConsumeX + "; shouldConsumeX=" + shouldConsumeX + "; position=" + position);
