...
import com.old.time.manager.AudioFocusManager;
import com.old.time.manager.MediaSessionManager;
 ...
 * 仅有从 {@link com.old.time.aidl.IPlayControl}.aidl 继承的方法在跨进程调用时有效<br>
...
public class PlayControlImpl extends com.old.time.aidl.IPlayControl.Stub {
